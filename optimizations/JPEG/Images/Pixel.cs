...
namespace JPEG.Images
{
    public class Pixel
    {
        ...
        public void SetYCbCr(double firstComponent, double secondComponent, double thirdComponent)
        {
            Y = firstComponent;
            Cb = secondComponent;
            Cr = thirdComponent;
        ...
        public void SetRGB(byte firstComponent, byte secondComponent, byte thirdComponent)
        {
            R = firstComponent;
            G = secondComponent;
            B = thirdComponent;
